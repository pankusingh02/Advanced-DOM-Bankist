...
console.log('gk=================>',gk2,fieldPlayers)
...
//Task6
 function printGoals(...playersgetting){
console.log('playersgetting==============>',playersgetting)
console.log(`${playersgetting.length} goals were scored`);
